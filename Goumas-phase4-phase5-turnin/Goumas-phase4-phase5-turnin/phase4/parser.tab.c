...
{
       0,   151,   151,   154,   158,   167,   175,   190,   197,   204,
     211,   218,   225,   232,   239,   246,   253,   263,   288,   314,
     315,   323,   331,   339,   347,   355,   367,   379,   391,   403,
     415,   427,   436,   445,   456,   462,   471,   480,   501,   522,
     543,   564,   573,   573,   600,   606,   612,   613,   620,   630,
     675,   690,   704,   709,   724,   730,   743,   752,   761,   768,
     774,   796,   804,   815,   821,   830,   854,   872,   896,   924,
     936,   947,   964,   973,   991,  1013,  1023,  1030,  1042,  1054,
    1055,  1054,  1060,  1065,  1059,  1079,  1097,  1134,  1143,  1161,
    1161,  1171,  1181,  1197,  1213,  1221,  1227,  1243,  1262,  1263,
    1263,  1287,  1288,  1288,  1320,  1327,  1336,  1347,  1357,  1381,
    1390,  1401,  1424,  1446,  1468,  1494,  1505,  1523,  1540,  1558,
    1574,  1582,  1590,  1598,  1613
};
#endif
...
#line 463 "parser.y"
    {
        ...
        emit(iMUL, (yyvsp[(2) - (2)].exprT), newexpr_constnum(-1), (yyval.exprT), 0, yylineno);
    ;}
    break;
...
#line 1198 "parser.y"
    {
        ...
        (yyval.exprT)->numConst = ptr;
        *((yyval.exprT)->numConst) = (yyvsp[(1) - (1)].numInt);
    ;}
    break;
